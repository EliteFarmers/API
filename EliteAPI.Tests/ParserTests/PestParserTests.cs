...
public class PestParserTests
{
	...
	public void ParsePestCropCollectionNumbersTest() {
		...
		PestParser.CalcUncountedCrops(Pest.Mite, 51, weightConfig).ShouldBe((int)Math.Ceiling(
			weightConfig.PestCropDropChances[Pest.Mite].GetCropsToSubtract(250, weightConfig: weightConfig) * 1));
