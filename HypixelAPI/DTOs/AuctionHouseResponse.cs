...
public class AuctionResponse {
	...
	[JsonPropertyName("profile_id")] public required string ProfileId { get; set; }
	...
	[JsonPropertyName("item_name")] public required string ItemName { get; set; }

	[JsonPropertyName("item_lore")] public string? ItemLore { get; set; }
	...
	[JsonPropertyName("starting_bid")] public long StartingBid { get; set; }
	...
	[JsonPropertyName("last_updated")] public long LastUpdated { get; set; }

	[JsonPropertyName("bin")] public bool Bin { get; set; }

	[JsonPropertyName("bids")] public List<AuctionBidResponse> Bids { get; set; } = [];
