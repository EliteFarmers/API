...
public class LeaderboardRegistrationService(IServiceScopeFactory provider) : ILeaderboardRegistrationService
{
	...
	public List<ILeaderboardDefinition> Leaderboards { get; } = [
		...
		new NormalNetworthLeaderboard(),
		new FunctionalNetworthLeaderboard(),
		new LiquidNetworthLeaderboard(),
		new FunctionalLiquidNetworthLeaderboard(),
		...
		new CropSunflowerLeaderboard(),
		new CropMoonflowerLeaderboard(),
		new CropWildRoseLeaderboard(),
		...
		new MilestoneSunflowerLeaderboard(),
		new MilestoneMoonflowerLeaderboard(),
		new MilestoneWildRoseLeaderboard(),
		...
		new PestDragonflyLeaderboard(),
		new PestFireflyLeaderboard(),
		new PestMantisLeaderboard(),
