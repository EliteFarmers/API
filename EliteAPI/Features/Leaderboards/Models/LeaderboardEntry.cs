...
public static class LeaderboardEntryExtensions
{
	...
	public static IQueryable<LeaderboardEntry> EntryFilter(this IQueryable<LeaderboardEntry> query,
		string? interval = null, RemovedFilter? removedFilter = RemovedFilter.NotRemoved, string? gameMode = null) {
	...
	public static IQueryable<LeaderboardEntryDto> MapToProfileLeaderboardEntries(
		this IQueryable<LeaderboardEntry> query, RemovedFilter removedFilter = RemovedFilter.NotRemoved) {
		return query
			.Include(e => e.Profile)
	...
	public static IQueryable<LeaderboardEntryDto> MapToMemberLeaderboardEntries(this IQueryable<LeaderboardEntry> query,
		bool includeMeta = false) {
		if (includeMeta) query = query.Include(a => a.ProfileMember!.MinecraftAccount!.EliteAccount!.UserSettings);
