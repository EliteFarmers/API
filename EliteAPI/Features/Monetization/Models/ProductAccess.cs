...
public class ProductAccess {
	...
	[ForeignKey(nameof(Guild))] public ulong? GuildId { get; set; }
	public Guild? Guild { get; set; }

	[ForeignKey(nameof(SourceOrder))] public Guid? SourceOrderId { get; set; }
	...
	public bool IsActive => !Revoked && StartDate <= DateTimeOffset.UtcNow &&
	...
	public bool HasLeaderboardStyle(int leaderboardStyleId) {
		return Product?.WeightStyles is { } list &&
		       list.Exists(l => l.Id == leaderboardStyleId && l.HasLeaderboardStyle());
	}
