...
) : EndpointWithoutRequest<GetSkyblockItemsResponse>
{
	public override void Configure() {
		...
		Options(o => { o.CacheOutput(c => c.Expire(TimeSpan.FromHours(1)).Tag("items")); });
	}
	...
	public override async Task HandleAsync(CancellationToken c) {
		var result = await context.SkyblockItems
			...
			.Where(s => s.Data != null)
			.ToDictionaryAsync(k => k.ItemId, v => v.Data, c);

		await Send.OkAsync(new GetSkyblockItemsResponse { Items = result }, c);
	}
}
