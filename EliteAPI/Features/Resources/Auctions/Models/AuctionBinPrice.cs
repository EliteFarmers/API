...
public class AuctionBinPrice
{
    ...
    public long ListedAtUnixMillis { get; set; }

    [Required]
    public required Guid AuctionUuid { get; set; }
...
public class AuctionBinPriceConfiguration : IEntityTypeConfiguration<AuctionBinPrice>
{
    ...
    {
        builder.HasIndex(e => new { e.SkyblockId, e.VariantKey, e.ListedAtUnixMillis });
        builder.HasIndex(e => e.AuctionUuid);
        builder.HasIndex(e => e.IngestedAtUtc);
    }
}