...
public class UserSettings
{
	...
	[MaxLength(16)] public string? Prefix { get; set; }
	[MaxLength(16)] public string? Suffix { get; set; }
	[MaxLength(256)] public string? EmojiUrl { get; set; }
	...
	[ForeignKey(nameof(WeightStyle))] public int? WeightStyleId { get; set; }
	public WeightStyle? WeightStyle { get; set; }

	[ForeignKey(nameof(LeaderboardStyle))] public int? LeaderboardStyleId { get; set; }
	public WeightStyle? LeaderboardStyle { get; set; }

	[ForeignKey(nameof(NameStyle))] public int? NameStyleId { get; set; }
