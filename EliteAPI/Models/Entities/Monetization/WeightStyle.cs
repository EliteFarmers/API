...
public class WeightStyle
{
	...
	[Column(TypeName = "jsonb")] public WeightStyleData Data { get; set; } = new();

	[Column(TypeName = "jsonb")] public LeaderboardStyleData? Leaderboard { get; set; }

	[Column(TypeName = "jsonb")] public NameStyleData? NameStyle { get; set; }

	public bool HasLeaderboardStyle() {
