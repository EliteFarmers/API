...
public class Event {
	...
	[MaxLength(64)] public string Name { get; set; } = "Unnamed Event";

	public bool Approved { get; set; }

	[MaxLength(1024)] public string? Description { get; set; }
	[MaxLength(1024)] public string? Rules { get; set; }
	[MaxLength(1024)] public string? PrizeInfo { get; set; }

	[ForeignKey("Banner")] [MaxLength(48)] public string? BannerId { get; set; }
	...
	[MaxLength(24)] public string? RequiredRole { get; set; }
	[MaxLength(24)] public string? BlockedRole { get; set; }
