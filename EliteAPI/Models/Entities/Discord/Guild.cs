...
public class Guild
{
	...
	[Column(TypeName = "jsonb")] public GuildFeatures Features { get; set; } = new();

	[MaxLength(64)] public string? InviteCode { get; set; }
	...
	[Column(TypeName = "jsonb")] public List<string> DiscordFeatures { get; set; } = [];
