...
public class AccountMapper : Profile
{
	public AccountMapper() {
		CreateMap<EliteAccount, AuthorizedAccountDto>()
			...
			.ForMember(a => a.Banner, opt => opt.MapFrom(a => a.Data != null ? a.Data.Banner : null))
			.ForMember(a => a.DismissedAnnouncements,
				opt => opt.MapFrom(a => a.DismissedAnnouncements.Select(d => d.AnnouncementId)))
