...
public class ConfigFarmingWeightSettings
{
    ...
    [JsonIgnore]
    public Dictionary<int, double>? WeightTargets { get; private set; }
...
public class PestDropChance {
    ...
    public double GetCropsToSubtract(int fortune, bool includeZero = false, bool usePrecomputed = true, ConfigFarmingWeightSettings? weightConfig = null) {
