...
public class AuctionHouseSettings
{
	...
	public double RecentFallbackMaxLookbackHours { get; set; } = 4;
	...
	public List<string> VariantOnlySkyblockIds { get; set; } = ["PET", "RUNE", "UNIQUE_RUNE", "ENCHANTED_BOOK", "POTION", "NEW_YEAR_CAKE", "ABICASE"];
