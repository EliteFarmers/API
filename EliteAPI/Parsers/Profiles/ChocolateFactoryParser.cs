...
public static class ChocolateFactoryParser {
	public static void ParseChocolateFactory(this ProfileMember member, RawMemberEasterEvent incoming, ChocolateFactorySettings settings) {
		...
		(factory.UniqueRabbits.Common, factory.TotalRabbits.Common) = CountRabbits(incoming, settings.Rabbits.Common.Rabbits);
		(factory.UniqueRabbits.Uncommon, factory.TotalRabbits.Uncommon) = CountRabbits(incoming, settings.Rabbits.Uncommon.Rabbits);
