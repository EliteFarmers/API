...
public static class FarmingToolParser {
	...
	public static Dictionary<string, long> ExtractToolCounters(this Models.Entities.Farming.Farming farming,
	...
	public static Dictionary<string, long> ExtractIncreasedToolCollections(this Dictionary<string, long> initialTools,
		List<ItemDto> currentTools) {
		return initialTools.ExtractIncreasedToolCollections(currentTools.ExtractToolCounters());
	}

	public static Dictionary<string, long> ExtractIncreasedToolCollections(this Dictionary<string, long> initialTools,
		Dictionary<string, long> currentTools) {
