...
public static class InventoryParser {
	public static void ParseInventory(this Models.Entities.Hypixel.Inventories inventories,
		...
		if (incoming.PersonalVaultContents is not null) inventories.PersonalVault = incoming.PersonalVaultContents.Data;
	...
	public static async Task<DecodedInventoriesDto> DecodeToNbt(this Models.Entities.Hypixel.Inventories inventories) {
		...
		if (backpacks is not null) await Task.WhenAll(backpacks);
