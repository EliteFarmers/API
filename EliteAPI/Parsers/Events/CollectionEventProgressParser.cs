...
{
	public static void UpdateScore(this CollectionEventMember eventMember, CollectionEvent @event, ProfileMember? member = null) {
	...
	public static void Initialize(this CollectionEventMember eventMember, CollectionEvent @event, ProfileMember member) {
