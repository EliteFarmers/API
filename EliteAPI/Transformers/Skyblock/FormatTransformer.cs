...
public static class FormatTransformer
{
...
public class SkyblockDate
{
    ...
    public DateTime GetDateTime() => FormatTransformer.GetTimeFromSkyblockDate(Year, Month, Day);
    public string MonthName() => FormatTransformer.GetSkyblockMonthName(Month);
    public override string ToString()
    {
        return $"{MonthName()} {FormatTransformer.AppendOrdinalSuffix(Day)}, Year {Year + 1}";
    }
}